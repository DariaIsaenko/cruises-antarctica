...
var advantagesLink = document.querySelector('.main-nav__link--advantages');
var catalogLink = document.querySelector('.main-nav__link--catalog');
var contactsLink = document.querySelector('.main-nav__link--contacts');
var overlay = document.querySelector('.main-nav__overlay');
var innerHeader = document.querySelector('.inner-header__wrapper');
...
advantagesLink.addEventListener('click', function () {
  return getLinkMobile('advantages');
});
catalogLink.addEventListener('click', function () {
  return getLinkMobile('catalog');
});
contactsLink.addEventListener('click', function () {
  return getLinkMobile('contacts');
});
